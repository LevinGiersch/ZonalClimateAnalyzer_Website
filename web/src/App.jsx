...
const TEXT = {
  de: {
    ...
    statusProcessing: 'Rasterstatistiken und Plots werden erstellt… Das kann ein paar Minuten dauern.',
  ...
  en: {
    ...
    statusProcessing: 'Generating raster stats and plots… This can take a few minutes.',
